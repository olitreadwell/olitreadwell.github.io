...
I built this simple increment counter with **Ruby**, the **Sinatra** framework, **JavaScript**, and **jQuery**. There's a **PostgreSQL** database to store the value of the counter. I use an **AJAX** request to asynchronously increase the value of the counter without refreshing the page. The application is hosted with **Heroku**.
...
## [Dungeons and Dragons Initiative Order (beta)](http://olitreadwell.com/portfolio/dnd-initiative-order)
