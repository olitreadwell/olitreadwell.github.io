...
![Songs by Sinatra Screenshot](/public/assets/img/songs-by-sinatra-screenshot.jpg)
...
You can view the full _Jump Start Sinatra_ repo I created [here](https://github.com/olitreadwell/jump-start-sinatra/tree/master/songs-by-sinatra).
...
You can view the full _Increment Counter with AJAX_ repo I created [here](https://github.com/olitreadwell/increment-counter-with-ajax/).
...
You can view the full _Movie Search with AJAX and jQuery_ repo I created [here](https://github.com/olitreadwell/movie-search-app/).

## [Dungeons and Dragons Initiative Order (beta)](dnd-initiative-order)

![Dungeons and Dragons Initiative Order (beta)](/public/assets/img/dnd-initiative-order-beta.jpg)
...
You can view the full _Dungeons and Dragons Initiative Order (beta)_ code I created [here](https://github.com/olitreadwell/olitreadwell.github.io/tree/master/portfolio/dnd-initiative-order/).
